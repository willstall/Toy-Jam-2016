...
var soundEffects =
[
    {id:"Cord", src:"test.mp3"},
    {id:"Spinner", src:"test2.mp3"},
    {id:"Selection", src:"test3.mp3"}
];
...
function playSelectedAudio( event )
{
	...
	var sound = getRandomSound( 0 );	// needs to be replaced with real id
